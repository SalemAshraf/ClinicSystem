    ...
    <div class="container pb-5">
        <div class="row gap-2">
            <div class="col-sm order-sm-2">
                <img src="../src/Views/clinic/assets/images/banner.jpg" class="img-fluid banner-img banner-img" alt="banner-image"
                    height="200">
            </div>
        ...
        <?php while ($row = $specialty->fetch_assoc()) { ?>
            <div class="card p-2" style="width: 18rem;">
                ...
                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                    ...
                    <a href="index.php?page=doctors&major_id=<?php echo $row['id']; ?>" class="btn btn-outline-primary card-button">
                        Browse Doctors
                    </a>
                </div>
            </div>
        ...
        <?php while ($row = $doctors->fetch_assoc()) { ?>
            <div class="card p-2" style="width: 18rem;">
                ...
                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                    ...
                    <a href="doctor.html" class="btn btn-outline-primary card-button">Book an appointment</a>
                </div>
            </div>
        <?php } ?>
    </div>
...
<div class="banner container d-block d-lg-grid d-md-block d-sm-block">
    ...
    <div class="bottom--right bg-blue text-white">
        <img src="../src/Views/clinic/assets/images/banner.jpg" class="img-fluid banner-img">
    </div>
</div>
</div>